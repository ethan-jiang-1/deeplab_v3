...
from metrics import pixel_accuracy, mean_accuracy, mean_IU, frequency_weighted_IU
...
def parse_args():
    ...
    args = Dotdict(args)
    return args, model_name, log_folder
...
def test(args, model_name, log_folder):
...
if __name__ == "__main__":
    args, model_name, log_folder = parse_args()

    test(args, model_name, log_folder)