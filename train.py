...
def train(args, training_dataset, validation_dataset):
...
if __name__ == "__main__":
    args = parse_args()
    training_dataset, validation_dataset = create_datasets(args)
    train(args, training_dataset, validation_dataset)
